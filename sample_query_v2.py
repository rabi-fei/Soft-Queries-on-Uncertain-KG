...
parser.add_argument("--output_folder", type=str, default='data/processed/ppi5k')
...
parser.add_argument("--sample_formula_scope", type=str, default='BetaE+real_EFO1', choices=['real_EFO1','BetaE+real_EFO1','EFOX_minimal', 'EFOX'])
...
if __name__ == "__main__":
    ...
    elif args.sample_formula_scope == 'BetaE+real_EFO1':
