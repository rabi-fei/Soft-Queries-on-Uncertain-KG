...
class ConjunctiveFormula:
    ...
    def sample_query(self, data_kg: KnowledgeGraph, strict_meaningful_negation: bool, query_method: str = 'solver'):
        """
        ...
        for pred in self.predicate_dict.values():
            ...
            if 'f' in pred.name:
                free_variable_list.append(pred.name)
