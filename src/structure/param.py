...
def set_params(data_name, task):
    ...
    elif data_name == 'onet20k':
        params.VOCAB_SIZE = 20643
        params.REL_VOCAB_SIZE = 19
    ...
    if data_name == 'cn15k':
        ...
        if params.early_stop == 'valid_mse' or params.early_stop == 'valid_mae': 
            ...
            params.LR = 1e-4
            params.EPOCH = 1000
            params.BATCH_SIZE = 4096 #first search
            params.regularization = {'delta': 1, 'min': 1e-3, 'rel_trans': 1e-3, 'rel_scale': 1e-3,
...
#    with open(file, 'rb') as f: #useless when eval mse/mae
