...
python3 train.py --log_dir log/fb15k/efl_round3 \
                 --learning_method efl --efl_round 3 \
                 --num_steps 50000 \
                 --eval_every 5000 \
                 --lr 1e-2 \
...
# good learning rate, efl round = 2
python3 train.py --log_dir log/efl_round3_family_lr1e-2 --num_steps 50000 --eval_every 5000 --lr 1e-2 --efl_round 3

python3 train.py --log_dir log/efl_round3_family_lr1e-2_batch_size=256 --num_steps 50000 --eval_every 5000 --lr 1e-2 --efl_round 3 --batch_size 256
...
# LPL family
python train.py --learning_method=lpl_family --log_dir log/lpl --eval_every 5000 --batch_size 512