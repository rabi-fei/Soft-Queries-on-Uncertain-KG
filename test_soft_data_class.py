...
if __name__ == "__main__":
    ...
    """
#    qa_dict = {'r1': 0, 'r2': 3, 'r3': 0, 's1': 2106}
#    lstr = "(r1(s1,e1,50%,1.0))&((r2(e1,f1,50%,1.0))&(r3(e1,f1,50%,1.0)))"
...
#    lstr = "(r1(s1,f1,50%,1.0))&(r2(s2,f1,50%,1.0))"
    ...
    qa_dict = {'s1': 1175, 's2': 793, 'r1': 0, 'r2': 0}
    lstr = "(!(r1(s1,f1,75%,0.4)))&(r2(s2,f1,25%,0.8))"
